<script lang="ts">
    ...
    // User options (only from current account)
    $: userOptions = [
    ...
    // Column definitions (no IP address column for users)
...
<PageContainer crumbs={pageCrumbs}>
    <PageHeader title="Audit Logs">
        <p slot="description">View audit logs for your account</p>
    </PageHeader>
        ...
        <Card>
            <CardHeader>
                <CardTitle class="flex items-center gap-2">
                    ...
                    Account: {data.currentAccount?.name || 'Unknown'}
                </CardTitle>
                <CardDescription>
                    Audit logs for users in your account
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <div class="w-64">
                            <Input
                                value={data.currentAccount?.name || 'Unknown'}
                                readonly
                                disabled
                                class="bg-muted/50 cursor-not-allowed h-9"
                                placeholder="Account"
                            />
                        </div>
                    ...
                    {:else if data.auditLogs.length === 0}
                        <div class="text-center py-8 text-muted-foreground">
                            ...
                            {#if userId || actionTypes.length > 0 || tableNames.length > 0}
