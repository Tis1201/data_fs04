...
>
    ...
    {:else}
        ...
        <AdminCard
            ...
            description="Best practices for managing link JWT signing keys"
        >
            <ul class="space-y-3">
                <li class="flex items-start gap-3">
                    <CheckCircle class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <div>
                        <h4 class="font-medium">Short-lived Links</h4>
                        <p class="text-sm text-muted-foreground">Link keys are used to sign tokens for invitation and password reset links</p>
                    </div>
                </li>
                <li class="flex items-start gap-3">
                    <CheckCircle class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                ...
                <li class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-muted-foreground">Old keys are kept for a grace period to verify existing links</p>
                    </div>
                </li>
            </ul>
        </AdminCard>
