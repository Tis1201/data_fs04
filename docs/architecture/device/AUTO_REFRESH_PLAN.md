...
4. ✅ Perform refresh action → verify apps reload after success
...
3. ✅ Perform install/uninstall/refresh
...
| `refresh` | ✅ YES | ✅ YES | Refresh triggers reconnect; reload after online |
...
const refreshActions = [
  ...
  'refresh',         // Device/service refresh → refresh apps + info
...
**Why refresh all for these actions?**
 ...
 - `refresh`: After refresh, device information and app state can change; reload on reconnect
