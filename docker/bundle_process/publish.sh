...
# Configuration
REGISTRY="registry.gitlab.com/fs040/web/fs04-web-bundle-process"
TAG="${1:-latest}"

echo "Publishing fs04-web-bundle-process:$TAG to $REGISTRY"

# Image name defined in docker-compose.yaml
LOCAL_IMAGE="fs04-web-bundle-process:${TAG}"
