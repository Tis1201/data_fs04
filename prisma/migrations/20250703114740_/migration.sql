...
INSERT INTO "new_WhatsAppAccount" ("accountId", "api_key", "client_id", "client_status", "createdAt", "createdBy", "description", "id", "name", "phoneNumber", "status", "updatedAt") SELECT "accountId", "api_key", "client_id", "client_status", "createdAt", "createdBy", "description", "id", "name", "phoneNumber", "status", "updatedAt" FROM "WhatsAppAccount";
