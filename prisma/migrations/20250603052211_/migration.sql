-- AlterTable
ALTER TABLE "Resource" ADD COLUMN "packageName" TEXT;
...
INSERT INTO "new_Bundle" ("accountId", "cancelAt", "createdAt", "createdBy", "description", "id", "name", "os", "reboot", "scheduledAt", "scheduledAtStartIfMissed", "scheduledAtTimezone", "status", "updatedAt", "updatedBy", "version", "waveSize") SELECT "accountId", "cancelAt", "createdAt", "createdBy", "description", "id", "name", "os", "reboot", "scheduledAt", "scheduledAtStartIfMissed", "scheduledAtTimezone", "status", "updatedAt", "updatedBy", "version", "waveSize" FROM "Bundle";
DROP TABLE "Bundle";
