...
main() {
    ...
    for table in $TABLES; do
        ...
        # Convert MergeTree to ReplicatedMergeTree - SKIPPED for Cloud (uses SharedMergeTree/Replicated by default)
    ...
    for mv in $MATERIALIZED_VIEWS; do
        ...
        # Convert MergeTree to ReplicatedMergeTree - SKIPPED for Cloud
        # sed -i.bak 's/MergeTree/ReplicatedMergeTree/g' "$file"
