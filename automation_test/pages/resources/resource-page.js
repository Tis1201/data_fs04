...
class ResourcePage extends BasePage {
    constructor(page) {
        ...
        // Page locators
        this.addButton = page.locator('button:has-text("Add Resource")');
    ...
    async goToPage() {
        await this.page.goto(config.pageURL.resources.url);
    ...
    async verifyAllSort(){
        ...
        await SortUtils.verifyColumnSorting(this.page, 'Type', 'text', false);
        await SortUtils.verifyColumnSorting(this.page, 'Target', 'text', false);
        await SortUtils.verifyColumnSorting(this.page, 'Version', 'text', false);
        await SortUtils.verifyColumnSorting(this.page, 'Format', 'text', false);
        ...
        await SortUtils.verifyColumnSorting(this.page, 'Type', 'text', true);
        await SortUtils.verifyColumnSorting(this.page, 'Target', 'text', true);
        await SortUtils.verifyColumnSorting(this.page, 'Version', 'text', true);
        await SortUtils.verifyColumnSorting(this.page, 'Format', 'text', true);
