...
test.describe('Section 1 — Device Control Action: Precondition, Loading, Connection', () => {
  test('TC-DA-001~003: Precondition, loading UI, and connected session', async ({ page }, testInfo) => {
...
test.describe('Section 2 — Activity Log Verification', () => {
  test('TC-DA-004: Verify Activity Log contains Control entry with Success status', async ({ page }, testInfo) => {
    test.setTimeout(4 * 60 * 1000);
...
test.describe('Section 3 — Negative: Disconnected State', () => {
  test('TC-DA-005: Verify disconnected UI when control session cannot connect', async ({ page }, testInfo) => {
    test.skip(
...
test.describe('Section 4 — Terminal Verification', () => {
  test('TC-DA-006: Start Control session and verify Terminal on the same Android device', async ({ page }, testInfo) => {
